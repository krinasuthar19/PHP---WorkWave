...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2024 at 12:18 PM
...
(4, 1000, '10000.00', '120.00', '10120.00', '2024-01-18'),
(5, 1000, '50000.00', '4566.00', '54566.00', '2024-01-18');
...
(1000, 'admin', 'admin', '', 'Admin', 'Admin', 'admin@123', 1111111111, '2005-01-06', 1, 1, 12000, '', '', '', 0, '', '', '', '0000-00-00'),
(1018, 'Yash Rana', '$2y$10$gi8H81z920Uuy', 'profile_images/img_65a8096461c66.jpg', 'Yash', 'Rana', 'yashrana6969@gmail.com', 2147483647, '2006-03-21', 2, 1, 0, 'Lj Polytechnic, sanand circle', 'ahmedabad', 'gujarat', 380061, 'india', '', 'male', '2024-01-01'),
(1024, 'Yoo Yeeee', '$2y$10$W9oYFoIEk/zLa', 'profile_images/img_65a897eb6b41f.png', 'Yoo', 'Yeeee', 'yoyee@ajd.axcxm', 1234567890, '2024-01-01', 3, 1, 0, 'dqAIUXGUK', 'WEFIHUI', 'FWEijo', 321654, 'eqefi', '', 'male', '2024-01-01'),
(1025, 'Yoo Yeeee', '$2y$10$pNPtrEMKWPaNY', 'profile_images/img_65a89a0d439fc.png', 'Yoo', 'Yeeee', 'yoyee@ajd.axcxm', 1234567890, '2024-01-01', 3, 1, 0, 'dqAIUXGUK', 'WEFIHUI', 'FWEijo', 321654, 'eqefi', '', 'male', '2024-01-01');
...
--
ALTER TABLE `users`
  MODIFY `u_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1026;
