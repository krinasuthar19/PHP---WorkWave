        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0 font-size-18">HR Salary confirms</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="javascript: void(0);">HR Salary confirms</a></li>
                  <li class="breadcrumb-item active">HR Salary confirms</li>
                </ol>
              </div>
            </div>
          </div>
