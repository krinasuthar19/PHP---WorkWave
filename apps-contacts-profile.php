                            ...
                            <div class="card-body">
                                                ...
                                                <div>
                                                   ...
                                                   <!-- <p class="text-muted font-size-13">Full Stack Developer</p>
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                        ...
                                                        <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i>yashrana@gmail.com</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <ul class="nav nav-tabs-custom card-header-tabs border-top mt-4" id="pills-tab" role="tablist">
                                   <!-- <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-3" data-bs-toggle="tab" href="#about" role="tab">Bio</a>
                                    </li>-->
                                   <!-- <li class="nav-item">
