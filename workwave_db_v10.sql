...
(1028, 'Bhakti Thakkar', '$2y$10$BxBhHoPrEwKLE', 'profile_images/img_65a9fdf126f9a.jpg', 'Bhakti', 'Thakkar', 'bhakti1@gmail.com', 2147483647, '2020-03-04', 3, 5, 0, 'ahm', 'ahm', 'guj', 321654, 'ind', '', 'female', '2024-01-03');
...
--
ALTER TABLE `users`
  MODIFY `u_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1029;
